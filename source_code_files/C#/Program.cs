...
// run:     ./C#/dp_knapsack_top-down $ ./bin/Debug/net7.0/dp_knapsack_top-down [no_picks, nopicks, picks_off, picksoff]
//
// build a release candidate:
// build:   ./C#/dp_knapsack_top-down $ dotnet publish -c Release -r linux-x64 --no-self-contained
//     dp_knapsack_top-down -> /home/booser/scripts/knapsack_in_different_lanuages/C#/dp_knapsack_top-down/bin/Release/net7.0/linux-x64/dp_knapsack_top-down.dll
//     dp_knapsack_top-down -> /home/booser/scripts/knapsack_in_different_lanuages/C#/dp_knapsack_top-down/bin/Release/net7.0/linux-x64/publish/
// run:     ./C#/dp_knapsack_top-down $ ./bin/Release/net7.0/linux-x64/dp_knapsack_top-down [no_picks, nopicks, picks_off, picksoff]
//
//
// to do:
//   -
//
//
// 2023-09-15: execution times with picks table activated:
//     01_WEIGHTS4.in                     8ms
//     02_WEIGHTS24_Kreher&Stinson.in   184ms
//     03_WEIGHTS100_Xu_Xu_et_al.in    9098ms
//     04_WEIGHTS_TODD_16.in             18ms
//     04_WEIGHTS_TODD_17.in             38ms
//     05_WEIGHTS_TODD_18.in             69ms
...
//
// 2023-09-15: execution times without picks table activated:
//     01_WEIGHTS4.in                     9ms
//     02_WEIGHTS24_Kreher&Stinson.in    57ms
//     03_WEIGHTS100_Xu_Xu_et_al.in    8848ms
//     04_WEIGHTS_TODD_16.in              1ms
//     04_WEIGHTS_TODD_17.in              2ms
//     05_WEIGHTS_TODD_18.in              2ms
//     06_WEIGHTS_TODD_19.in              2ms
